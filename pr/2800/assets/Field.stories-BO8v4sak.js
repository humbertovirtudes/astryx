import{at as n,ad as e}from"./iframe-yRFQ_7VC.js";import{X as t}from"./XDSField-COi97ivg.js";import{X as D}from"./XDSTextInput-C1ju8zVt.js";import{F as S}from"./EnvelopeIcon-DngpXttg.js";import"./preload-helper-Ct5FWWRu.js";import"./XDSFieldStatus-BgnciRVy.js";import"./inputStyles.stylex-BIqXE6lP.js";import"./groupStyles-BZhxclV-.js";import"./useInputContainer-DjJ5nP5w.js";import"./useClickableContainer-B3IEmxS8.js";const i=({id:a,describedBy:r,placeholder:s,value:l,onChange:o})=>e.jsx("input",{id:a,"aria-describedby":r,placeholder:s,value:l,onChange:u=>o(u.target.value),className:"xh8yej3 x9f619 x9ynric xif65rj xce4md1 xrrkdod xmkeg23 x1y0btm7 x14i3s5s xh6dtrn x10xzikg x1tgivj0 x1a2a7pz xnw553j"}),W={title:"Core/Field",component:t,tags:["autodocs"],argTypes:{label:{control:"text"},isLabelHidden:{control:"boolean"},description:{control:"text"},isOptional:{control:"boolean"},isRequired:{control:"boolean"},labelTooltip:{control:"text"}}},d={args:{label:"Email"},render:a=>{const[r,s]=n.useState("");return e.jsx(t,{...a,inputID:"email-input",children:e.jsx(i,{id:"email-input",placeholder:"you@example.com",value:r,onChange:s})})}},c={args:{label:"Email",description:"We'll never share your email."},render:a=>{const[r,s]=n.useState("");return e.jsx(t,{...a,inputID:"email-desc-input",descriptionID:"email-desc",children:e.jsx(i,{id:"email-desc-input",describedBy:"email-desc",placeholder:"you@example.com",value:r,onChange:s})})}},p={args:{label:"Search",isLabelHidden:!0},render:a=>{const[r,s]=n.useState("");return e.jsx(t,{...a,inputID:"search-input",children:e.jsx(i,{id:"search-input",placeholder:"Search...",value:r,onChange:s})})}},m={args:{label:"Nickname",isOptional:!0},render:a=>{const[r,s]=n.useState("");return e.jsx(t,{...a,inputID:"nickname-input",children:e.jsx(i,{id:"nickname-input",placeholder:"Enter your nickname",value:r,onChange:s})})}},v={args:{label:"Username",isRequired:!0},render:a=>{const[r,s]=n.useState("");return e.jsx(t,{...a,inputID:"username-input",children:e.jsx(i,{id:"username-input",placeholder:"Enter your username",value:r,onChange:s})})}},h={args:{label:"API Key",labelTooltip:"Your unique API key. Keep this secret!"},render:a=>{const[r,s]=n.useState("");return e.jsx(t,{...a,inputID:"api-key-input",children:e.jsx(i,{id:"api-key-input",placeholder:"sk-...",value:r,onChange:s})})}},g={args:{label:"Email",labelIcon:S},render:a=>{const[r,s]=n.useState("");return e.jsx(t,{...a,inputID:"email-icon-input",children:e.jsx(i,{id:"email-icon-input",placeholder:"you@example.com",value:r,onChange:s})})}},x={render:()=>{const[a,r]=n.useState({a:"",b:"",c:"",d:"",e:""}),s=l=>o=>r(u=>({...u,[l]:o}));return e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:24,maxWidth:320},children:[e.jsx(t,{label:"Default",inputID:"v-a",children:e.jsx(i,{id:"v-a",value:a.a,onChange:s("a")})}),e.jsx(t,{label:"With description",description:"Some helpful info",inputID:"v-b",descriptionID:"v-b-desc",children:e.jsx(i,{id:"v-b",describedBy:"v-b-desc",value:a.b,onChange:s("b")})}),e.jsx(t,{label:"Optional",isOptional:!0,inputID:"v-c",children:e.jsx(i,{id:"v-c",value:a.c,onChange:s("c")})}),e.jsx(t,{label:"Required",isRequired:!0,inputID:"v-d",children:e.jsx(i,{id:"v-d",value:a.d,onChange:s("d")})}),e.jsx(t,{label:"With tooltip",labelTooltip:"Extra info here",inputID:"v-e",children:e.jsx(i,{id:"v-e",value:a.e,onChange:s("e")})})]})}},b={render:()=>{const[a,r]=n.useState({error:"bad-email",warning:"admin",success:"valid-user"}),s=l=>o=>r(u=>({...u,[l]:o}));return e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:24,maxWidth:400},children:[e.jsx(D,{label:"Email",description:"Enter your work email",value:a.error,onChange:s("error"),status:{type:"error",message:"Please enter a valid email address"}}),e.jsx(D,{label:"Username",description:"Choose a unique username",value:a.warning,onChange:s("warning"),status:{type:"warning",message:"This username is reserved for administrators"}}),e.jsx(D,{label:"API Key",description:"Paste your API key",value:a.success,onChange:s("success"),status:{type:"success",message:"API key is valid and active"}})]})}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  ...
  render: args => {
    const [value, setValue] = useState('');
    return <XDSField {...args} inputID="email-desc-input" descriptionID="email-desc">
  ...
  render: args => {
    const [value, setValue] = useState('');
    return <XDSField {...args} inputID="search-input">
  ...
  render: args => {
    const [value, setValue] = useState('');
    return <XDSField {...args} inputID="nickname-input">
  ...
  render: args => {
    const [value, setValue] = useState('');
    return <XDSField {...args} inputID="username-input">
  ...
  render: args => {
    const [value, setValue] = useState('');
    return <XDSField {...args} inputID="api-key-input">
  ...
  render: args => {
    const [value, setValue] = useState('');
    return <XDSField {...args} inputID="email-icon-input">
  ...
  render: () => {
    ...
    return <div style={{
      ...
      maxWidth: 320
        ...
        <XDSField label="With description" description="Some helpful info" inputID="v-b" descriptionID="v-b-desc">
        ...
        <XDSField label="With tooltip" labelTooltip="Extra info here" inputID="v-e">
  ...
  render: () => {
    ...
    return <div style={{
      ...
      maxWidth: 400
        ...
        <XDSTextInput label="Email" description="Enter your work email" value={vals.error} onChange={set('error')} status={{
        type: 'error',
        message: 'Please enter a valid email address'
      }} />
        <XDSTextInput label="Username" description="Choose a unique username" value={vals.warning} onChange={set('warning')} status={{
        type: 'warning',
        message: 'This username is reserved for administrators'
      }} />
        <XDSTextInput label="API Key" description="Paste your API key" value={vals.success} onChange={set('success')} status={{
        type: 'success',
