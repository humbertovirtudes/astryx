import{ad as e,r as k,at as i,X as P}from"./iframe-yRFQ_7VC.js";import{X as s}from"./XDSMarkdown-C51mApFy.js";import{X as w}from"./XDSLink-CIWTg4UH.js";import"./preload-helper-Ct5FWWRu.js";import"./XDSCodeBlock-B5b8s25t.js";import"./highlightRanges-DQjygsEE.js";import"./XDSCheckboxListItem-G66nArwI.js";import"./XDSField-COi97ivg.js";import"./XDSFieldStatus-BgnciRVy.js";import"./XDSList-B0MkGqZF.js";import"./XDSListItem-C5CIKGjL.js";import"./XDSItem-CTSSy95c.js";import"./computeTargetAndRel-BlG0ENK0.js";import"./XDSCheckboxInput-C50y4c1Q.js";import"./XDSBlockquote-kq4Y3FPM.js";import"./XDSTable-tIgxviJL.js";import"./XDSEmptyState-CWiMy9oI.js";import"./useXDSStreamingText-CdCvbZFo.js";import"./XDSCitation-DzquwPCW.js";import"./XDSCode-CEZ5ThnD.js";import"./useXDSInteractiveRole-C4QNKBOy.js";const Q={title:"Core/Markdown",component:s,tags:["autodocs"],argTypes:{density:{control:"select",options:["default","compact"]},headingLevelStart:{control:"select",options:[1,2,3,4,5,6]},isStreaming:{control:"boolean"},display:{control:"select",options:["block","inline"]}}},b=["# XDSMarkdown Demo","","Renders **markdown** with *design-system-consistent* styling.","","## Features","","- Headings mapped to XDS type scale","- **Bold**, *italic*, and ~~strikethrough~~ text","- [Links](https://example.com) with external detection","- Inline `code` and fenced code blocks","","### Code Block","","```typescript","interface User {","  id: string;","  name: string;","}","","function greet(user: User) {","  return `Hello, ${user.name}!`;","}","```","","### Blockquote","","> Design systems free teams to focus on problems that matter.","","### Table","","| Component | Status | Tests |","|:----------|:------:|------:|","| XDSMarkdown | Active | 73 |","| XDSCodeBlock | Active | 44 |","","### Task List","","- [x] Parser","- [x] Renderer","- [ ] Storybook stories","","---","","1. First ordered item","2. Second ordered item"].join(`
...
`),o={args:{children:b}},d={args:{children:b,density:"compact"}},c={name:"AI Response",args:{children:v,density:"compact",headingLevelStart:3}},l={name:"Shifted Headings (start at h3)",args:{children:b,headingLevelStart:3}},p={name:"Inline Display",render:()=>e.jsxs("div",{style:{maxWidth:680,display:"grid",gap:16},children:[e.jsx(k,{type:"large",display:"block",children:e.jsx(s,{display:"inline",children:"Use `value` with **controlled state** and [read the docs](https://example.com) without creating block wrappers."})}),e.jsxs("div",{style:{border:"1px solid #ddd",borderRadius:8,padding:12,display:"grid",gap:6},children:[e.jsx(k,{type:"body",weight:"bold",display:"block",children:"Prop description"}),e.jsx(k,{type:"body",color:"secondary",display:"block",children:e.jsx(s,{display:"inline",children:'Accepts an action item `{label, onClick?, icon?}`, a divider `{type: "divider"}`, or a section `{type: "section", items: [...]}`.'})})]})]})},m={name:"Table",args:{children:["## Comparison Table","","| Feature | React | Vue | Svelte |","|:--------|:-----:|:---:|-------:|","| Virtual DOM | Yes | Yes | No |","| Bundle Size | ~40KB | ~30KB | ~2KB |","| TypeScript | Native | Plugin | Native |","| Learning Curve | Medium | Easy | Easy |"].join(`
`)}},h={render:()=>{const a=v,[r,n]=i.useState(0),[t,f]=i.useState(!0),[D,I]=i.useState(0);i.useEffect(()=>{if(!t)return;if(r>=a.length){f(!1);return}const x=Math.floor(Math.random()*8)+2,C=30+Math.random()*60,M=setTimeout(()=>{n(R=>Math.min(R+x,a.length))},C);return()=>clearTimeout(M)},[r,t,a]);const T=i.useCallback(()=>{n(0),f(!0),I(x=>x+1)},[]);return e.jsxs("div",{children:[e.jsxs("div",{style:{marginBlockEnd:12,display:"flex",gap:8,alignItems:"center"},children:[e.jsx(P,{label:"Replay",variant:"secondary",size:"sm",onClick:T,isDisabled:t}),e.jsx("span",{style:{fontSize:12,color:"#666"},children:t?`Streaming... ${r}/${a.length}`:"Complete"})]}),e.jsx(s,{isStreaming:t,density:"compact",headingLevelStart:3,children:a.slice(0,r)},D)]})}},g={name:"With Images",render:()=>e.jsx("div",{style:{maxWidth:800},children:e.jsx(s,{children:`
  ...
  render: () => {
    ...
    return <div>
        ...
        alignItems: 'center'
          ...
          <XDSButton label="Replay" variant="secondary" size="sm" onClick={replay} isDisabled={isStreaming} />
          <span style={{
          fontSize: 12,
          color: '#666'
        }}>
...
\`}</XDSMarkdown>
  ...
  render: () => {
    const inlinePlugins = [{
      ...
      render: (match: RegExpMatchArray, key: string) => <XDSLink key={key} href={\`https://issues.example.com/browse/\${match[1]}\`} isExternalLink weight="semibold">
            {match[0]}
          </XDSLink>
    }, {
      // GitHub-style issue references: #123, #456, etc.
      pattern: /#(\\d+)/g,
      render: (match: RegExpMatchArray, key: string) => <XDSLink key={key} href={\`https://github.com/org/repo/issues/\${match[1]}\`} isExternalLink weight="semibold">
            {match[0]}
          </XDSLink>
    }];
...
}`,...S.parameters?.docs?.source}}};const ee=["Default","Compact","AIResponse","ShiftedHeadings","InlineDisplay","TableFocused","Streaming","WithImages","ContentAlignStart","ContentAlignCenter","InlinePlugins"];export{c as AIResponse,d as Compact,y as ContentAlignCenter,u as ContentAlignStart,o as Default,p as InlineDisplay,S as InlinePlugins,l as ShiftedHeadings,h as Streaming,m as TableFocused,g as WithImages,ee as __namedExportsOrder,Q as default};
