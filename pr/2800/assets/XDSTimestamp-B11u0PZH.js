...
import{_ as V}from"./preload-helper-Ct5FWWRu.js";import{at as c,ai as z,aZ as H,ad as u,r as L,aj as P}from"./iframe-yRFQ_7VC.js";const k=c.lazy(async()=>V(()=>import("./iframe-yRFQ_7VC.js").then(e=>e.w),__vite__mapDeps([0,1,2]),import.meta.url).then(e=>({default:e.XDSTooltip}))),p=60,f=3600,o=86400,h=30*o,y=365*o,U=7*o;function Y(e){return typeof e=="number"?new Date(e<1e12?e*1e3:e):new Date(e)}function Z(e,s){const a=Math.round((s.getTime()-e.getTime())/1e3);if(a<0){const t=Math.abs(a);if(t<p)return"in a few seconds";if(t<f){const n=Math.round(t/p);return`in ${n} ${n===1?"minute":"minutes"}`}if(t<o){const n=Math.round(t/f);return`in ${n} ${n===1?"hour":"hours"}`}if(t<h){const n=Math.round(t/o);return`in ${n} ${n===1?"day":"days"}`}if(t<y){const n=Math.round(t/h);return`in ${n} ${n===1?"month":"months"}`}const r=Math.round(t/y);return`in ${r} ${r===1?"year":"years"}`}if(a<10)return"just now";if(a<p)return`${a} seconds ago`;if(a<f){const t=Math.round(a/p);return`${t} ${t===1?"minute":"minutes"} ago`}if(a<o){const t=Math.round(a/f);return`${t} ${t===1?"hour":"hours"} ago`}if(a<2*o)return"yesterday";if(a<h)return`${Math.round(a/o)} days ago`;if(a<y){const t=Math.round(a/h);return`${t} ${t===1?"month":"months"} ago`}const i=Math.round(a/y);return`${i} ${i===1?"year":"years"} ago`}function l(e){return String(e).padStart(2,"0")}function W(e,s,a){switch(s){case"date":return new Intl.DateTimeFormat(void 0,{year:"numeric",month:"short",day:"numeric"}).format(e);case"date_time":return new Intl.DateTimeFormat(void 0,{year:"numeric",month:"short",day:"numeric",hour:"numeric",minute:"2-digit",...a?{timeZoneName:"short"}:{}}).format(e);case"time":return new Intl.DateTimeFormat(void 0,{hour:"numeric",minute:"2-digit",...a?{timeZoneName:"short"}:{}}).format(e);case"system_date":{const i=e.getFullYear(),t=l(e.getMonth()+1),r=l(e.getDate());return`${i}-${t}-${r}`}case"system_date_time":{const i=e.getFullYear(),t=l(e.getMonth()+1),r=l(e.getDate()),n=l(e.getHours()),v=l(e.getMinutes()),g=l(e.getSeconds());return`${i}-${t}-${r} ${n}:${v}:${g}`}case"system_time":{const i=l(e.getHours()),t=l(e.getMinutes()),r=l(e.getSeconds());return`${i}:${t}:${r}`}}}function B(e){return new Intl.DateTimeFormat(void 0,{year:"numeric",month:"long",day:"numeric",hour:"numeric",minute:"2-digit",second:"2-digit",timeZoneName:"short"}).format(e)}function C(e){const s=Math.abs(e);return s<p?1e3:s<f?3e4:s<o?6e4:3e5}function G(e){return e!=="relative"&&e!=="auto"}function D({value:e,format:s="auto",autoThreshold:a=U,hasTooltip:i=!0,isTimezoneShown:t=!1,isLive:r=!1,type:n="supporting",size:v,color:g="secondary",weight:S,xstyle:$,className:M,style:R,ref:X,"data-testid":q}){const x=c.useRef(null),[_,I]=c.useState(()=>new Date),d=Y(e),E=d.toISOString(),T=Math.round((_.getTime()-d.getTime())/1e3),m=s==="auto"?Math.abs(T)<=a?"relative":"date_time":s,j=m==="relative"?Z(d,_):G(m)?W(d,m,t):"",b=B(d);c.useEffect(()=>{if(!r||m!=="relative")return;const O=C(T),N=setInterval(()=>{I(new Date)},O);return()=>clearInterval(N)},[r,m,T]);const F=i&&m==="relative",A=z(H("timestamp",{format:m}),{className:M,style:R}),w=u.jsx(L,{type:n,size:v,color:g,weight:S,xstyle:$,...A,children:u.jsx("time",{ref:P(X,x),dateTime:E,"aria-label":m==="relative"?b:void 0,"data-testid":q,className:"xdst0psk2 xdsjb2p0i xds1j61x8r xds1qlqyl8 xds15bjb6t xds1heor9g xds1pd3egz",children:j})});return F?u.jsxs(u.Fragment,{children:[w,u.jsx(c.Suspense,{fallback:null,children:u.jsx(k,{anchorRef:x,content:b,placement:"above"})})]}):w}D.displayName="XDSTimestamp";D.__docgenInfo={description:`Displays a formatted timestamp as human-readable text.
...
@default 'secondary'`,defaultValue:{value:"'secondary'",computed:!1}},weight:{required:!1,tsType:{name:"union",raw:"'normal' | 'medium' | 'semibold' | 'bold'",elements:[{name:"literal",value:"'normal'"},{name:"literal",value:"'medium'"},{name:"literal",value:"'semibold'"},{name:"literal",value:"'bold'"}]},description:"Font weight override."},"data-testid":{required:!1,tsType:{name:"string"},description:"Test ID for testing frameworks."}},composes:["Omit"]};export{D as X};
