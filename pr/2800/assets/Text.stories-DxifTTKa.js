...
descriptions. This example shows how Text types pair with content.`,...r.parameters?.docs?.description}}};const L=["Body","Large","Label","Supporting","Code","AllTypes","ColorVariants","WeightVariants","DisplayModes","SingleLineTruncation","MultiLineTruncation","TruncationWithoutTooltip","TruncationVariants","MultiLineTruncationTooltip","WordBreakVariants","TextWrapVariants","Strikethrough","TabularNumbers","Capsize","AsElements","CardExample","MetricsExample","FormLikeContext"];export{n as AllTypes,D as AsElements,o as Body,S as Capsize,w as CardExample,d as Code,p as ColorVariants,x as DisplayModes,r as FormLikeContext,l as Label,s as Large,X as MetricsExample,h as MultiLineTruncation,i as MultiLineTruncationTooltip,y as SingleLineTruncation,T as Strikethrough,a as Supporting,g as TabularNumbers,v as TextWrapVariants,u as TruncationVariants,b as TruncationWithoutTooltip,c as WeightVariants,m as WordBreakVariants,L as __namedExportsOrder,k as default};
