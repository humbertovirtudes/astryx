  ...
  render: () => {
    ...
    return <div style={{
      ...
      maxWidth: '300px'
        ...
        <XDSTimeInput label="Default (12h)" value={value1} onChange={setValue1} placeholder="Select a time" />
        <XDSTimeInput label="24-hour format" value={value2} onChange={setValue2} hourFormat="24h" />
        <XDSTimeInput label="With seconds" value={value3} onChange={setValue3} hasSeconds />
        <XDSTimeInput label="With clear button" value={value4} onChange={setValue4} hasClear placeholder="Select a time" />
        <XDSTimeInput label="With description" description="Pick your preferred time" value={value5} onChange={setValue5} placeholder="Select a time" />
        <XDSTimeInput label="Disabled" isDisabled value={value6} onChange={setValue6} />
        <XDSTimeInput label="With error" value={value7} onChange={setValue7} status={{
        type: 'error',
        message: 'Invalid time selection'
      }} />
      </div>;
  }
}`,...I.parameters?.docs?.source}}};const L=["Default","WithValue","TwentyFourHourFormat","WithSeconds","WithClearButton","WithDescription","WithMinMax","WithIncrement","Optional","Required","Disabled","SmallSize","WithErrorStatus","WithWarningStatus","WithSuccessStatus","AllVariations"];export{I as AllVariations,i as Default,h as Disabled,p as Optional,g as Required,v as SmallSize,l as TwentyFourHourFormat,c as WithClearButton,d as WithDescription,b as WithErrorStatus,S as WithIncrement,m as WithMinMax,o as WithSeconds,V as WithSuccessStatus,u as WithValue,T as WithWarningStatus,L as __namedExportsOrder,H as default};
