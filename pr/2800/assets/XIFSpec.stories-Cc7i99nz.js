import{ad as s,r as h,at as C}from"./iframe-yRFQ_7VC.js";import{X as R}from"./XDSDivider-CD2fc5JP.js";import{X as u}from"./XDSStack-CFJ7xIVk.js";import{X as S}from"./XDSHeading---Kr4LhL.js";import{X as F}from"./XDSSVGIcon-DiUzYXAd.js";import"./preload-helper-Ct5FWWRu.js";import"./stack.stylex-5XIQDawT.js";const ee={name:"check",paths:[{type:"path",attrs:{d:"M5 13l4 4L19 7"},role:"stroke"}],tags:["action","confirm"]},W={name:"home",paths:[{type:"path",attrs:{d:"M3 10a2 2 0 0 1 .709-1.528l7-5.999a2 2 0 0 1 2.582 0l7 5.999A2 2 0 0 1 21 10v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"},role:"fill",layer:"primary"},{type:"path",attrs:{d:"M15 21v-8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v8"},role:"fill",layer:"secondary"}],tags:["navigation"]},N={name:"file",paths:[{type:"path",attrs:{d:"M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"},role:"fill",layer:"primary"},{type:"path",attrs:{d:"M14 2v4a2 2 0 0 0 2 2h4"},role:"stroke",layer:"secondary"}],slots:[{name:"badge",position:{x:.5,y:.65},size:.35}],tags:["file","document"]},_={name:"shield",paths:[{type:"path",attrs:{d:"M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"},role:"fill",layer:"primary"}],slots:[{name:"badge",position:"center",size:.42}],tags:["security","protection"]},U={name:"bell",paths:[{type:"path",attrs:{d:"M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9"},role:"fill",layer:"primary",animate:{type:"scale",sequence:1}},{type:"path",attrs:{d:"M10.3 21a1.94 1.94 0 0 0 3.4 0"},role:"stroke",layer:"secondary",animate:{type:"draw",sequence:2}}],tags:["notification","alert"]},Y={name:"star",paths:[{type:"path",attrs:{d:"M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z"},role:"fill",layer:"primary",personality:{cornerRounding:0}}],tags:["rating","favorite"]},te={name:"bell-override",paths:[{type:"path",attrs:{d:"M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9"},role:"fill",layer:"primary"},{type:"path",attrs:{d:"M10.3 21a1.94 1.94 0 0 0 3.4 0"},role:"stroke",layer:"secondary"}],overrides:{bold:[{type:"path",attrs:{d:"M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9"},role:"fill",layer:"primary"},{type:"path",attrs:{d:"M10.3 21a1.94 1.94 0 0 0 3.4 0"},role:"fill",layer:"secondary"}]},tags:["notification"]},ae=[ee,W,N,_,U,Y,te];function E(o){const a=[],l=/([MmLlHhVvCcSsQqTtAaZz])([^MmLlHhVvCcSsQqTtAaZz]*)/g;let i,r=0,n=0,c=0,p=0;for(;(i=l.exec(o))!==null;){const d=i[1],t=(i[2].match(/-?[\d.]+(?:e[+-]?\d+)?/gi)||[]).map(Number);switch(d){case"M":r=t[0],n=t[1],c=r,p=n,a.push({type:"M",x:r,y:n});for(let e=2;e<t.length;e+=2)r=t[e],n=t[e+1],a.push({type:"L",x:r,y:n});break;case"m":r+=t[0],n+=t[1],c=r,p=n,a.push({type:"M",x:r,y:n});for(let e=2;e<t.length;e+=2)r+=t[e],n+=t[e+1],a.push({type:"L",x:r,y:n});break;case"L":for(let e=0;e<t.length;e+=2)r=t[e],n=t[e+1],a.push({type:"L",x:r,y:n});break;case"l":for(let e=0;e<t.length;e+=2)r+=t[e],n+=t[e+1],a.push({type:"L",x:r,y:n});break;case"H":for(let e=0;e<t.length;e++)r=t[e],a.push({type:"L",x:r,y:n});break;case"h":for(let e=0;e<t.length;e++)r+=t[e],a.push({type:"L",x:r,y:n});break;case"V":for(let e=0;e<t.length;e++)n=t[e],a.push({type:"L",x:r,y:n});break;case"v":for(let e=0;e<t.length;e++)n+=t[e],a.push({type:"L",x:r,y:n});break;case"C":for(let e=0;e<t.length;e+=6)a.push({type:"C",x1:t[e],y1:t[e+1],x2:t[e+2],y2:t[e+3],x:t[e+4],y:t[e+5]}),r=t[e+4],n=t[e+5];break;case"c":for(let e=0;e<t.length;e+=6)a.push({type:"C",x1:r+t[e],y1:n+t[e+1],x2:r+t[e+2],y2:n+t[e+3],x:r+t[e+4],y:n+t[e+5]}),r+=t[e+4],n+=t[e+5];break;case"Q":for(let e=0;e<t.length;e+=4)a.push({type:"Q",cx:t[e],cy:t[e+1],x:t[e+2],y:t[e+3]}),r=t[e+2],n=t[e+3];break;case"q":for(let e=0;e<t.length;e+=4)a.push({type:"Q",cx:r+t[e],cy:n+t[e+1],x:r+t[e+2],y:n+t[e+3]}),r+=t[e+2],n+=t[e+3];break;case"A":case"a":{const e=d==="a";for(let y=0;y<t.length;y+=7){const x=e?r+t[y+5]:t[y+5],f=e?n+t[y+6]:t[y+6];a.push({type:"A",rx:t[y],ry:t[y+1],rotation:t[y+2],large:t[y+3],sweep:t[y+4],x,y:f}),r=x,n=f}break}case"S":case"s":break;case"T":case"t":break;case"Z":case"z":a.push({type:"Z"}),r=c,n=p;break}}return a}function w(o,a){return Math.sqrt((a.x-o.x)**2+(a.y-o.y)**2)}function b(o,a,l){return{x:o.x+(a.x-o.x)*l,y:o.y+(a.y-o.y)*l}}function G(o,a){const l=o.x*a.x+o.y*a.y,i=Math.sqrt(o.x**2+o.y**2),r=Math.sqrt(a.x**2+a.y**2);return i===0||r===0?Math.PI:Math.acos(Math.max(-1,Math.min(1,l/(i*r))))}function g(o){return o.type==="Z"?null:{x:o.x,y:o.y}}function J(o,a){if(a<=0)return o;a=Math.min(1,a);const l=E(o),i=[];for(let r=0;r<l.length;r++){const n=r>0?l[r-1]:null,c=l[r],p=r<l.length-1?l[r+1]:null;if(c.type==="Z"&&n&&(n.type==="L"||n.type==="Q")){let d=r-1;for(;d>=0&&l[d].type!=="M";)d--;if(d>=0){const t=l[d],e=g(t),y=g(n);if(!e||!y){i.push(c);continue}let x=d+1;for(;x<l.length&&l[x].type!=="L";)x++;if(x<l.length){const f=g(l[x]);if(!f){i.push(c);continue}const k=w(y,e),v=w(e,f),L=Math.min(k,v)/2,V={x:y.x-e.x,y:y.y-e.y},X={x:f.x-e.x,y:f.y-e.y},B=1-G(V,X)/Math.PI,D=L*a*B*.85;if(D>=.1){const M=D/k,z=D/v,I=b(e,y,M),q=b(e,f,z);i.push({type:"L",x:I.x,y:I.y}),i.push({type:"Q",cx:e.x,cy:e.y,x:q.x,y:q.y}),i.push({type:"Z"});continue}}}i.push(c);continue}if(c.type==="L"&&n&&(n.type==="L"||n.type==="M"||n.type==="Q")&&p&&(p.type==="L"||p.type==="Z")){const d=g(n);if(!d){i.push(c);continue}const t={x:c.x,y:c.y};let e;if(p.type==="Z"){const z=l.find(I=>I.type==="M");e=z?g(z):null}else e=g(p);if(!e){i.push(c);continue}const y=w(d,t),x=w(t,e),f=Math.min(y,x)/2,k={x:d.x-t.x,y:d.y-t.y},v={x:e.x-t.x,y:e.y-t.y},V=1-G(k,v)/Math.PI,X=f*a*V*.85;if(X<.1){i.push(c);continue}const Q=X/y,B=X/x,D=b(t,d,Q),M=b(t,e,B);i.push({type:"L",x:D.x,y:D.y}),i.push({type:"Q",cx:t.x,cy:t.y,x:M.x,y:M.y})}else i.push(c)}return O(i)}function K(o,a){if(a<=0)return o;a=Math.min(1,a);const l=E(o),i=[];for(let r=0;r<l.length;r++){const n=r>0?l[r-1]:null,c=l[r];if(c.type==="L"&&n){const p=g(n);if(!p){i.push(c);continue}const d={x:c.x,y:c.y},t=w(p,d);if(t<2){i.push(c);continue}const e=b(p,d,.5),y=d.x-p.x,f=-(d.y-p.y)/t,k=y/t,v=t*a*.25,L={x:e.x+f*v,y:e.y+k*v};i.push({type:"Q",cx:L.x,cy:L.y,x:d.x,y:d.y})}else i.push(c)}return O(i)}function se(o,a){if(a===.5)return o;const l=E(o),i=[],r=1.5-a;for(let n=0;n<l.length;n++){const c=n>0?l[n-1]:null,p=l[n];if(p.type==="C"&&c){const d=g(c)||{x:0,y:0},t={x:p.x,y:p.y},e={x:d.x+(p.x1-d.x)*r,y:d.y+(p.y1-d.y)*r},y={x:t.x+(p.x2-t.x)*r,y:t.y+(p.y2-t.y)*r};i.push({type:"C",x1:e.x,y1:e.y,x2:y.x,y2:y.y,x:t.x,y:t.y})}else if(p.type==="Q"&&c){const d=g(c)||{x:0,y:0},t={x:p.x,y:p.y},e=b(d,t,.5),y={x:e.x+(p.cx-e.x)*r,y:e.y+(p.cy-e.y)*r};i.push({type:"Q",cx:y.x,cy:y.y,x:t.x,y:t.y})}else i.push(p)}return O(i)}function re(o,a){let l=o;return a.cornerRounding!=null&&a.cornerRounding>0&&(l=J(l,a.cornerRounding)),a.segmentCurvature!=null&&a.segmentCurvature>0&&(l=K(l,a.segmentCurvature)),a.tension!=null&&a.tension!==.5&&(l=se(l,a.tension)),l}function m(o){return Number(o.toFixed(3)).toString()}function O(o){return o.map(a=>{switch(a.type){case"M":return`M${m(a.x)} ${m(a.y)}`;case"L":return`L${m(a.x)} ${m(a.y)}`;case"C":return`C${m(a.x1)} ${m(a.y1)} ${m(a.x2)} ${m(a.y2)} ${m(a.x)} ${m(a.y)}`;case"Q":return`Q${m(a.cx)} ${m(a.cy)} ${m(a.x)} ${m(a.y)}`;case"A":return`A${m(a.rx)} ${m(a.ry)} ${m(a.rotation)} ${a.large} ${a.sweep} ${m(a.x)} ${m(a.y)}`;case"Z":return"Z"}}).join(" ")}function j(o){const a=r=>r.filter(n=>(n.type??"path")!=="ellipse").map(n=>({type:n.type??"path",attrs:Object.fromEntries(Object.entries(n.attrs).map(([c,p])=>[c,String(p)])),role:n.role})),l=a(o.paths.filter(r=>(r.layer??"primary")==="primary")),i=a(o.paths.filter(r=>r.layer==="secondary"));return{name:o.name,viewBox:o.viewBox,primary:l,secondary:i.length>0?i:void 0}}const he={title:"Lab/XIFSpec"},Z=["linear","bold","twotone","bulk","broken"],A={render:()=>s.jsxs(u,{direction:"vertical",gap:3,children:[s.jsx(S,{level:3,children:"XIF Spec Examples"}),s.jsx(h,{type:"supporting",children:"Icons defined using the XDS Icon Format specification. Each demonstrates a different capability: stroke-only, two-layer knockout, composable slots, animation declarations, personality overrides, and bold geometry overrides."}),s.jsxs("div",{style:{display:"grid",gridTemplateColumns:`140px repeat(${Z.length}, 1fr)`,gap:"8px 4px",alignItems:"center"},children:[s.jsx("div",{}),Z.map(o=>s.jsx(h,{type:"label",style:{textAlign:"center",fontSize:10},children:o},o)),ae.map(o=>{const a=j(o),l=[];return o.slots?.length&&l.push("🔌 slots"),o.paths.some(i=>i.animate)&&l.push("✨ animated"),o.paths.some(i=>i.personality)&&l.push("🎨 personality"),o.overrides&&l.push("🔀 overrides"),o.paths.some(i=>i.layer==="secondary")&&l.push("📐 two-layer"),s.jsxs(C.Fragment,{children:[s.jsxs("div",{children:[s.jsx(h,{type:"label",style:{fontSize:11},children:o.name}),l.length>0&&s.jsx(h,{type:"supporting",style:{fontSize:9,marginTop:2},children:l.join(" ")})]}),Z.map(i=>s.jsx("div",{style:{display:"flex",justifyContent:"center"},children:s.jsx(F,{icon:a,variation:i,size:"lg"})},`${o.name}-${i}`))]},o.name)})]})]})},P={render:()=>{const o=j(_),a=j(N),l={name:"shield-check",primary:[...o.primary],secondary:[{type:"path",attrs:{d:"M9 13l2 2 4-4"},role:"stroke"}]},i={name:"shield-x",primary:[...o.primary],secondary:[{type:"path",attrs:{d:"M9 9l6 6M15 9l-6 6"},role:"stroke"}]},r={name:"file-text",primary:[...a.primary],secondary:[...a.secondary??[],{type:"line",attrs:{x1:"9",y1:"13",x2:"15",y2:"13"},role:"stroke"},{type:"line",attrs:{x1:"9",y1:"17",x2:"13",y2:"17"},role:"stroke"}]};return s.jsxs(u,{direction:"vertical",gap:3,children:[s.jsx(S,{level:3,children:"Composition via Slots"}),s.jsxs(h,{type:"supporting",children:["Icons with ",s.jsx("code",{children:"slots"})," accept sub-icons. One shield base + different badges = many composed icons without extra path data."]}),s.jsx(u,{direction:"horizontal",gap:4,children:[{label:"shield (base)",def:o},{label:"shield-check",def:l},{label:"shield-x",def:i},{label:"file (base)",def:a},{label:"file-text",def:r}].map(({label:n,def:c})=>s.jsxs(u,{direction:"vertical",gap:1,hAlign:"center",children:[s.jsxs(u,{direction:"horizontal",gap:2,children:[s.jsx(F,{icon:c,variation:"linear",size:"lg"}),s.jsx(F,{icon:c,variation:"bold",size:"lg"})]}),s.jsx(h,{type:"supporting",style:{fontSize:10},children:n})]},n))}),s.jsx(R,{}),s.jsx(S,{level:4,children:"Slot Definition"}),s.jsxs(h,{type:"supporting",children:["The shield icon defines:"," ",s.jsx("code",{children:"slots: [{ name: 'badge', position: 'center', size: 0.42 }]"}),". At render time, the component scales and positions the badge icon into the slot. The badge inherits the parent's variation and color."]})]})}},H={render:()=>{const o=j(Y),a=j(W),l=j(U),i=[{name:"Brutalist",desc:"Sharp corners, straight lines, tight curves"},{name:"Technical",desc:"Minimal rounding, precise geometry"},{name:"Default",desc:"Balanced — slight softening"},{name:"Friendly",desc:"Rounded corners, subtle curves"},{name:"Playful",desc:"Very rounded, bowed segments"}];return s.jsxs(u,{direction:"vertical",gap:3,children:[s.jsx(S,{level:3,children:"Personality Axes (Conceptual)"}),s.jsxs(h,{type:"supporting",children:["Shape personality parameters adjust the ",s.jsx("em",{children:"feel"})," of icons without changing their structure. All adjustments are relative, preserving the artist's hierarchy of sharp vs soft. These icons show the concept; path manipulation is not yet implemented."]}),s.jsxs("div",{style:{display:"grid",gridTemplateColumns:"120px repeat(5, 1fr)",gap:"12px 8px",alignItems:"center"},children:[s.jsx("div",{}),i.map(r=>s.jsxs(u,{direction:"vertical",gap:0,hAlign:"center",children:[s.jsx(h,{type:"label",style:{fontSize:10},children:r.name}),s.jsx(h,{type:"supporting",style:{fontSize:8},children:r.desc})]},r.name)),[{name:"star",def:o},{name:"home",def:a},{name:"bell",def:l}].map(({name:r,def:n})=>s.jsxs(C.Fragment,{children:[s.jsx(h,{type:"label",style:{fontSize:11},children:r}),i.map((c,p)=>s.jsx("div",{style:{display:"flex",justifyContent:"center",opacity:.3+p*.175},children:s.jsx(F,{icon:n,variation:"linear",size:"lg",strokeWidth:1.5-p*.1})},c.name))]},r))]}),s.jsx(h,{type:"supporting",children:"Note: opacity/stroke-width are used as visual placeholders here. The real implementation will modify path geometry, rounding corners, bowing segments, adjusting curve tension, all at build time via the theme pipeline."})]})}},$={render:()=>{const o=`
      ...
      alignItems: 'center'
        ...
        return <Fragment key={xif.name}>
              ...
              fontSize: 11
                ...
                {features.length > 0 && <XDSText type="supporting" style={{
              fontSize: 9,
              marginTop: 2
            }}>
                    {features.join(' ')}
  ...
  render: () => {
    ...
    return <XDSStack direction="vertical" gap={3}>
        ...
        alignItems: 'center'
          ...
          <div />
          {presets.map(p => <XDSStack key={p.name} direction="vertical" gap={0} hAlign="center">
              <XDSText type="label" style={{
            fontSize: 10
          }}>
                {p.name}
          ...
          def
            ...
            opacity: 0.3 + i * 0.175
                  ...
                  <XDSSVGIcon icon={def} variation="linear" size="lg" strokeWidth={1.5 - i * 0.1} />
                </div>)}
            </Fragment>)}
        </div>
  ...
  render: () => {
    ...
    return <XDSStack direction="vertical" gap={3}>
        ...
        gap: 24
          ...
          {demos.map(demo => <XDSStack key={demo.name} direction="vertical" gap={1} hAlign="center" style={{
          padding: 16
        }}>
  ...
  render: () => {
    ...
    return <XDSStack direction="vertical" gap={4}>
        ...
        alignItems: 'center'
          ...
          <div />
          {roundingLevels.map(r => <XDSText key={r} type="label" style={{
          textAlign: 'center',
          fontSize: 10
        }}>
              {r}
        ...
        alignItems: 'center'
          ...
          <div />
          {curvatureLevels.map(c => <XDSText key={c} type="label" style={{
          textAlign: 'center',
          fontSize: 10
        }}>
              {c}
        ...
        alignItems: 'center'
          ...
          r: 0.8,
          c: 0.3
        }].map(p => <XDSStack key={p.label} direction="vertical" hAlign="center" gap={0}>
              <XDSText type="label" style={{
            fontSize: 10
          }}>
                {p.label}
...
}`,...T.parameters?.docs?.source},description:{story:`Interactive path transform playground.
Demonstrates corner rounding, segment curvature, and tension
with live SVG rendering.`,...T.parameters?.docs?.description}}};const me=["SpecExamples","CompositionSlots","PersonalityAxes","AnimationIntent","PathTransformPlayground"];export{$ as AnimationIntent,P as CompositionSlots,T as PathTransformPlayground,H as PersonalityAxes,A as SpecExamples,me as __namedExportsOrder,he as default};
