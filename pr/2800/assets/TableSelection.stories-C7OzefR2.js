  ...
  render: () => {
    ...
    return <div style={{
      maxWidth: 600
        ...
        <XDSTable data={users} columns={columns} idKey="id" density="compact" plugins={{
        selection: selectionPlugin
      }} />
      </div>;
  }
  ...
  render: () => {
    ...
    return <div style={{
      maxWidth: 600
        ...
        <XDSTable data={users} columns={columns} idKey="id" density="spacious" hasHover plugins={{
        selection: selectionPlugin
      }} />
      </div>;
  }
  ...
  render: () => {
    ...
    return <div style={{
      maxWidth: 600
        ...
        <XDSTable data={users} columns={columns} idKey="id" isStriped plugins={{
        selection: selectionPlugin
      }} />
      </div>;
  }
}`,...K.parameters?.docs?.source}}};const w=["Default","WithPreselection","NonSelectableRows","DisabledRows","Compact","Spacious","WithStripedRows"];export{g as Compact,u as Default,y as DisabledRows,m as NonSelectableRows,p as Spacious,S as WithPreselection,K as WithStripedRows,w as __namedExportsOrder,X as default};
