import{at as s,ad as n}from"./iframe-yRFQ_7VC.js";import{X as r}from"./XDSDateInput-Xu2D3XhU.js";import{X as w,b as R}from"./XDSLayoutContent-DBrMIkuH.js";import"./preload-helper-Ct5FWWRu.js";import"./XDSField-COi97ivg.js";import"./XDSFieldStatus-BgnciRVy.js";import"./inputStyles.stylex-BIqXE6lP.js";import"./XDSCalendar-DnQEEy7F.js";import"./plainDate-C-ANv9VG.js";import"./useXDSPopover-ChRJmaAz.js";import"./dateParser-CpYVMWHj.js";import"./stack.stylex-5XIQDawT.js";import"./stackItem.stylex-CYo-hkeX.js";import"./padding.stylex-BDg7w1Mn.js";const U={title:"Core/DateInput",component:r,tags:["autodocs"],argTypes:{label:{control:"text",description:"Label text (required)"},isLabelHidden:{control:"boolean",description:"Visually hide the label (still accessible to screen readers)"},placeholder:{control:"text",description:"Placeholder text"},description:{control:"text",description:"Description text displayed between the label and input"},isOptional:{control:"boolean",description:"Whether the field is optional (mutually exclusive with isRequired)"},isRequired:{control:"boolean",description:"Whether the field is required (mutually exclusive with isOptional)"},isDisabled:{control:"boolean",description:"Whether the input is disabled"},size:{control:"radio",options:["sm","md","lg"],description:"Size of the input"},numberOfMonths:{control:"radio",options:[1,2],description:"Number of months to display in calendar"}}},l={render:e=>{const[a,t]=s.useState(void 0);return n.jsx(r,{...e,value:a,onChange:t})},args:{label:"Date",placeholder:"Select a date"}},o={render:e=>{const[a,t]=s.useState("2026-01-25");return n.jsx(r,{...e,value:a,onChange:t})},args:{label:"Event date"}},u={render:e=>{const[a,t]=s.useState(void 0);return n.jsx(r,{...e,value:a,onChange:t})},args:{label:"Birthday",description:"Enter your date of birth",placeholder:"Select your birthday"}},i={render:e=>{const[a,t]=s.useState(void 0);return n.jsx(r,{...e,value:a,onChange:t})},args:{label:"Date",isLabelHidden:!0,placeholder:"Select a date"}},d={render:e=>{const[a,t]=s.useState(void 0);return n.jsx(r,{...e,value:a,onChange:t})},args:{label:"Preferred date",isOptional:!0,placeholder:"Select a date (optional)"}},c={render:e=>{const[a,t]=s.useState(void 0);return n.jsx(r,{...e,value:a,onChange:t})},args:{label:"Start date",isRequired:!0,placeholder:"Select a start date"}},p={render:e=>{const[a,t]=s.useState("2026-01-25");return n.jsx(r,{...e,value:a,onChange:t})},args:{label:"Locked date",isDisabled:!0}},S={render:e=>{const[a,t]=s.useState(void 0);return n.jsx(r,{...e,value:a,onChange:t})},args:{label:"Date",size:"sm",placeholder:"Select a date"}},g={render:e=>{const[a,t]=s.useState(void 0);return n.jsx(r,{...e,value:a,onChange:t})},args:{label:"Booking date",min:"2026-01-15",max:"2026-02-15",description:"Available dates: Jan 15 - Feb 15, 2026",placeholder:"Select a booking date"}},h={render:e=>{const[a,t]=s.useState(void 0);return n.jsx(w,{height:"auto",content:n.jsx(R,{children:n.jsx(r,{...e,value:a,onChange:t})})})},args:{label:"End date",max:new Date().toISOString().slice(0,10),description:"Max is today; open the calendar to verify the label does not turn grey when nav buttons are disabled",placeholder:"Select an end date"}},v={render:e=>{const[a,t]=s.useState(void 0);return n.jsx(r,{...e,value:a,onChange:t})},args:{label:"Travel date",numberOfMonths:2,placeholder:"Select a travel date"}},m={render:e=>{const[a,t]=s.useState("2026-01-25");return n.jsx(r,{...e,value:a,onChange:t})},args:{label:"Event date",status:{type:"error",message:"This date is not available"}}},D={render:e=>{const[a,t]=s.useState("2026-01-01");return n.jsx(r,{...e,value:a,onChange:t})},args:{label:"Meeting date",status:{type:"warning",message:"This is a holiday - are you sure?"}}},b={render:e=>{const[a,t]=s.useState("2026-02-10");return n.jsx(r,{...e,value:a,onChange:t})},args:{label:"Appointment date",status:{type:"success",message:"Date is available"}}},V={render:()=>{const[e,a]=s.useState(void 0),[t,C]=s.useState("2026-01-25"),[x,O]=s.useState(void 0),[y,W]=s.useState(void 0),[X,j]=s.useState(void 0),[E,L]=s.useState("2026-03-10"),[M,q]=s.useState("2026-01-25");return n.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px",maxWidth:"300px"},children:[n.jsx(r,{label:"Default",value:e,onChange:a,placeholder:"Select a date"}),n.jsx(r,{label:"With value",value:t,onChange:C}),n.jsx(r,{label:"With description",description:"Pick your preferred date",value:x,onChange:O,placeholder:"Select a date"}),n.jsx(r,{label:"Optional field",isOptional:!0,value:y,onChange:W,placeholder:"Select a date (optional)"}),n.jsx(r,{label:"Required field",isRequired:!0,value:X,onChange:j,placeholder:"Select a date"}),n.jsx(r,{label:"Disabled",isDisabled:!0,value:E,onChange:L}),n.jsx(r,{label:"With error",value:M,onChange:q,status:{type:"error",message:"Invalid date selection"}})]})}},f={render:e=>{const[a,t]=s.useState("2026-04-06");return n.jsx(r,{...e,value:a,onChange:t,hasClear:!0})},args:{label:"Event date",placeholder:"Select a date"}},I={render:e=>{const[a,t]=s.useState("2026-04-06");return n.jsx(r,{...e,value:a,onChange:t,hasClear:!0})},args:{label:"Deadline",status:{type:"error",message:"Date is in the past"}}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  ...
  render: args => {
    const [value, setValue] = useState<ISODateString | undefined>(undefined);
    return <XDSLayout height="auto" content={<XDSLayoutContent>
  ...
  render: () => {
    ...
    return <div style={{
      ...
      maxWidth: '300px'
        ...
        <XDSDateInput label="Default" value={value1} onChange={setValue1} placeholder="Select a date" />
        <XDSDateInput label="With value" value={value2} onChange={setValue2} />
        <XDSDateInput label="With description" description="Pick your preferred date" value={value3} onChange={setValue3} placeholder="Select a date" />
        <XDSDateInput label="Optional field" isOptional value={value4} onChange={setValue4} placeholder="Select a date (optional)" />
        <XDSDateInput label="Required field" isRequired value={value5} onChange={setValue5} placeholder="Select a date" />
        <XDSDateInput label="Disabled" isDisabled value={value6} onChange={setValue6} />
        <XDSDateInput label="With error" value={value7} onChange={setValue7} status={{
        type: 'error',
  ...
  render: args => {
    ...
    return <XDSDateInput {...args} value={value} onChange={setValue} hasClear />;
  },
  args: {
    label: 'Event date',
    placeholder: 'Select a date'
