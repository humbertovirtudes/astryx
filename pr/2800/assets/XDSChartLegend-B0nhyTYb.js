...
<XDSChartLegend
  ...
  label="Change %"
/>
\`\`\``,methods:[],displayName:"XDSChartLegend",props:{items:{required:!1,tsType:{name:"Array",elements:[{name:"XDSChartLegendItem"}],raw:"XDSChartLegendItem[]"},description:"Discrete legend items — color swatches with labels"},gradient:{required:!1,tsType:{name:"Array",elements:[{name:"string"}],raw:"string[]"},description:`Continuous gradient — array of hex colors from low to high.
Pass the output of useXDSChartColors().sequential.blue(5) or diverging directly.`},domain:{required:!1,tsType:{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},description:"Numeric domain for the gradient [min, max]. Required when gradient is set."},label:{required:!1,tsType:{name:"string"},description:"Label for the gradient legend"},ticks:{required:!1,tsType:{name:"number"},description:"Number of tick labels on the gradient bar (default: 3)",defaultValue:{value:"3",computed:!1}},tickFormat:{required:!1,tsType:{name:"signature",type:"function",raw:"(value: number) => string",signature:{arguments:[{type:{name:"number"},name:"value"}],return:{name:"string"}}},description:"Custom tick formatter",defaultValue:{value:"String",computed:!0}}}};export{h as X};
