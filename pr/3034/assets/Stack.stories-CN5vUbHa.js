import{ar as b,at as q,ai as w,a_ as N,ad as e}from"./iframe-BsyQNsjg.js";import{S as r}from"./Stack-BJArovWs.js";import{s as P}from"./stackItem.stylex-CgqrJM4N.js";import"./preload-helper-Ct5FWWRu.js";import"./stack.stylex-BlarxY2N.js";function i({crossAlignSelf:s,size:c,as:j="div",xstyle:u,className:v,style:f,children:A,ref:z,...I}){const C=b(...P({crossAlignSelf:s,size:c}),u);return q.createElement(j,{ref:z,...w(N("stack-item",{size:c}),C,v,f),...I},A)}i.displayName="StackItem";i.__docgenInfo={description:`Stack item component for controlling individual item behavior within a stack.
