import{at as t,ad as e,ai as z,ar as N,a_ as L,T as F}from"./iframe-BsyQNsjg.js";import{a as T,F as k}from"./Field-CwBWJ3UK.js";import{T as o}from"./TextInput-Cf1TABMG.js";import{S as v}from"./Selector-CjIQMyWd.js";import"./preload-helper-Ct5FWWRu.js";import"./FieldStatus-CpbQmNrj.js";import"./inputStyles.stylex-Bpqcd25J.js";import"./groupStyles-BY4Vty6g.js";import"./useInputContainer-BL7yVuZB.js";import"./useClickableContainer-PI23cXZ9.js";import"./usePopover-BIgzi40u.js";import"./Divider-Dde5c7Qn.js";import"./utils-_uNaBhDK.js";import"./hooks-DJx48dsA.js";import"./Item-ls6cDVeU.js";import"./computeTargetAndRel-BlG0ENK0.js";const g={base:{k1xSpc:"astryx78zum5",kXwgrk:"astryxdt5ytf",kOIVth:"astryx18g69wz",$$css:!0},horizontal:{k1xSpc:"astryxrvj5dj",kprqdN:"astryx1mt1orb",klIVar:"astryxu6a5m6",$$css:!0},horizontalLabels:{k1xSpc:"astryxrvj5dj",kumcoG:"astryx1pmbctz",kOIVth:"astryxlaq8a2",kGNEyG:"astryx7a106z",k41HbU:"astryxedohl4",kUxVDj:"astryx1rpgqan",k3RL8M:"astryx1a1jff",$$css:!0}};function i({children:s,direction:a="vertical",xstyle:l,className:r,style:n,ref:m,...c}){const u=t.useMemo(()=>({direction:a}),[a]);return e.jsx(T,{value:u,children:e.jsx("div",{ref:m,...z(L("form-layout",{direction:a}),N(g.base,a==="horizontal"&&g.horizontal,a==="horizontal-labels"&&g.horizontalLabels,l),r,n),...c,children:s})})}i.displayName="FormLayout";i.__docgenInfo={description:`Spatial layout container for form fields.
...
\`\`\``,methods:[],displayName:"FormLayout",props:{xstyle:{required:!1,tsType:{name:"StyleXStyles"},description:"StyleX styles created via `stylex.create()`. Merged with the component's\nbase styles inside a single `stylex.props()` call for optimal deduplication.\n\n@example\n```\nconst overrides = stylex.create({ root: { marginBottom: 8 } });\n<Component xstyle={overrides.root} />\n```"},ref:{required:!1,tsType:{name:"ReactRef",raw:"React.Ref<HTMLDivElement>",elements:[{name:"HTMLDivElement"}]},description:"Ref forwarded to the root element"},children:{required:!1,tsType:{name:"ReactNode"},description:`Form fields to arrange. Accepts XDS inputs (TextInput, Selector, etc.)
...
}`,...b.parameters?.docs?.source}}};const X=["Vertical","Horizontal","HorizontalLabels","MixedControls","Nested","InDialog"];export{p as Horizontal,x as HorizontalLabels,b as InDialog,y as MixedControls,h as Nested,d as Vertical,X as __namedExportsOrder,O as default};
