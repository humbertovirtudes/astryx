import{at as m,ad as e,ai as T,ar as R,a_ as N,aT as F,aj as L}from"./iframe-BsyQNsjg.js";import{F as A}from"./HomeIcon-djbNUyDm.js";import{F as _}from"./FolderIcon-COTo-hJy.js";import{F as G}from"./Cog6ToothIcon-DNod7bVm.js";import"./preload-helper-Ct5FWWRu.js";const E=m.createContext({variant:"default",separator:"/"});E.displayName="BreadcrumbContext";const X={root:{k1xSpc:"astryx1lliihq",$$css:!0}};function t({children:s,separator:u="/",variant:c="default",xstyle:l,className:o,style:p,label:h="Breadcrumb",ref:x,...y}){const b=m.useMemo(()=>({variant:c,separator:u}),[c,u]);return e.jsx(E,{value:b,children:e.jsx("nav",{ref:x,"aria-label":h,...T(N("breadcrumbs",{variant:c}),R(X.root,l),o,p),...y,children:e.jsx("ol",{className:"astryx78zum5 astryx6s0dn4 astryx1a02dak astryxe8uvvx astryx1ghz6dp astryx1717udv astryxzye2dw",children:s})})})}t.displayName="Breadcrumbs";t.__docgenInfo={description:`A navigation breadcrumb trail. Wraps BreadcrumbItem children in
...
the hierarchy.`,...i.parameters?.docs?.description}}};const ee=["Default","TwoLevels","AutoDetectCurrent","CustomSeparator","WithIcons","WithOnClick","DeepHierarchy","SupportingVariant","SupportingWithIcons","CurrentOnMiddleItem"];export{j as AutoDetectCurrent,i as CurrentOnMiddleItem,I as CustomSeparator,w as DeepHierarchy,g as Default,S as SupportingVariant,z as SupportingWithIcons,B as TwoLevels,v as WithIcons,C as WithOnClick,ee as __namedExportsOrder,Z as default};
