import{at as n,ad as e,ai as h,ar as d,a_ as O,T as x,I as p,B as S}from"./iframe-BsyQNsjg.js";import{T as w}from"./TextInput-Cf1TABMG.js";import"./preload-helper-Ct5FWWRu.js";import"./Field-CwBWJ3UK.js";import"./FieldStatus-CpbQmNrj.js";import"./inputStyles.stylex-Bpqcd25J.js";import"./groupStyles-BY4Vty6g.js";import"./useInputContainer-BL7yVuZB.js";import"./useClickableContainer-PI23cXZ9.js";const Q=n.createContext(null);Q.displayName="StepperContext";function he(){const s=n.use(Q);if(s==null)throw new Error("useStepperContext must be used within Stepper. Wrap your Step in <Stepper>.");return s}const Y={root:{k1xSpc:"astryx78zum5",kzqmXN:"astryxh8yej3",kH6xsr:"astryx3ct3a4",kogj98:"astryx1ghz6dp",kmVPX3:"astryx1717udv",$$css:!0},horizontal:{kXwgrk:"astryx1q0g3np",kGNEyG:"astryx1cy8zhl",kOIVth:"astryx195vfkc",$$css:!0},vertical:{kXwgrk:"astryxdt5ytf",kOIVth:"astryx195vfkc",$$css:!0}};function i({activeStep:s,children:a,orientation:y="horizontal",onStepClick:u,label:V="Progress",density:o="balanced",xstyle:m,className:H,style:G,ref:b,...X}){const k=n.useMemo(()=>({activeStep:s,orientation:y,isNonLinear:u!=null,onStepClick:u??null,density:o}),[s,y,u,o]);return e.jsx(Q,{value:k,children:e.jsx("ol",{ref:b,"aria-label":V,...X,...h(O("stepper",{orientation:y}),d(Y.root,y==="horizontal"?Y.horizontal:Y.vertical,m),H,G),children:a})})}i.displayName="Stepper";i.__docgenInfo={description:`A stepper component for multi-step workflows. Displays numbered steps
...
}`,...L.parameters?.docs?.source}}};const Me=["Default","DefaultHorizontal","NumberedVertical","NumberedHorizontal","StatusVertical","StatusAllStates","MinimalVertical","MinimalHorizontal","IndicatorComparison","WithContentSlot","DensityComparison","TwoSteps","ManySteps","DisabledSteps","OptionalSteps","LongLabels"];export{C as Default,z as DefaultHorizontal,D as DensityComparison,B as DisabledSteps,M as IndicatorComparison,L as LongLabels,R as ManySteps,$ as MinimalHorizontal,T as MinimalVertical,N as NumberedHorizontal,A as NumberedVertical,E as OptionalSteps,W as StatusAllStates,q as StatusVertical,P as TwoSteps,I as WithContentSlot,Me as __namedExportsOrder,$e as default};
