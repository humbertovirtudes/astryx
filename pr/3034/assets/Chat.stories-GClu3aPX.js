import{ad as e,B as m,F as j}from"./iframe-BsyQNsjg.js";import{C as r}from"./ChatMessageList-B3-cwwUK.js";import{C as a}from"./ChatMessage-CIyBEJT9.js";import{C as s}from"./ChatMessageBubble-DFoYBmf0.js";import{a as o,C as t,F as w,b as B}from"./HandThumbUpIcon-D6HtNbQA.js";import{A as l}from"./Avatar-o5VRDMVP.js";import{M as i}from"./Markdown-BPKYfmUZ.js";import{T as v}from"./Token-VOWYDPCX.js";import{C as f}from"./CodeBlock-D6wOP1I-.js";import{T as n}from"./Timestamp-Ce1lmfYz.js";import{H as S}from"./HStack-BfY7xapt.js";import"./preload-helper-Ct5FWWRu.js";import"./ChatContext-DI64GbG6.js";import"./Divider-Dde5c7Qn.js";import"./CheckboxListItem-rav7Z1RX.js";import"./Field-CwBWJ3UK.js";import"./FieldStatus-CpbQmNrj.js";import"./List-BvnhqnJa.js";import"./ListItem-BbfLZ1zc.js";import"./Item-ls6cDVeU.js";import"./computeTargetAndRel-BlG0ENK0.js";import"./CheckboxInput-A4vOtGqU.js";import"./Blockquote-qTccG1Qt.js";import"./Table-DbWwTk6p.js";import"./EmptyState-B2QAVwKi.js";import"./useStreamingText-CKZh63Ww.js";import"./Citation-jIUfuAuS.js";import"./Code-DUs3QDLC.js";import"./useInteractiveRole-De3Y2qEg.js";import"./highlightRanges-EIPCprQf.js";import"./Stack-BJArovWs.js";import"./stack.stylex-BlarxY2N.js";const re={title:"Core/Chat",component:r,tags:["autodocs"]},c={name:"Default",render:()=>e.jsx("div",{style:{display:"flex",flexDirection:"column"},children:e.jsxs(r,{children:[e.jsx(a,{sender:"user",children:e.jsx(s,{metadata:e.jsx(t,{timestamp:e.jsx(n,{value:"2026-03-15T14:30:00",format:"time"}),status:"read"}),children:"How should I handle state management in a React app?"})}),e.jsxs(a,{sender:"assistant",children:[e.jsx(i,{density:"compact",children:`For most cases, **React's built-in state** is sufficient:
...
Avoid global state managers unless you have a genuine need for cross-cutting state. Most apps are over-engineered in this area.`}),e.jsx(t,{timestamp:e.jsx(n,{value:"2026-03-15T14:30:30",format:"time"}),footer:e.jsxs(e.Fragment,{children:[e.jsx("span",{children:"Claude Opus 4.6"}),e.jsx("span",{children:"·"}),e.jsx(m,{label:"Thumbs up",icon:e.jsx(w,{style:{width:14,height:14}}),variant:"ghost",size:"sm",isIconOnly:!0}),e.jsx(m,{label:"Thumbs down",icon:e.jsx(B,{style:{width:14,height:14}}),variant:"ghost",size:"sm",isIconOnly:!0}),e.jsx(m,{label:"Copy",icon:e.jsx(j,{style:{width:14,height:14}}),variant:"ghost",size:"sm",isIconOnly:!0})]})})]}),e.jsx(a,{sender:"user",children:e.jsx(s,{metadata:e.jsx(t,{timestamp:e.jsx(n,{value:"2026-03-15T14:31:00",format:"time"}),status:"read"}),children:"Can you show me a useReducer example?"})}),e.jsxs(a,{sender:"assistant",children:[e.jsx(i,{density:"compact",children:"Here's a common pattern for form state:"}),e.jsx(f,{code:`const reducer = (state, action) => {
  switch (action.type) {
    case 'SET_FIELD':
...
}`,...b.parameters?.docs?.source}}};const ie=["Default","MixedContent","ChatConversation","DensityComparison","GapOverride","SystemMessages","MessageStatus","MultiBubble"];export{g as ChatConversation,c as Default,p as DensityComparison,x as GapOverride,C as MessageStatus,u as MixedContent,b as MultiBubble,M as SystemMessages,ie as __namedExportsOrder,re as default};
