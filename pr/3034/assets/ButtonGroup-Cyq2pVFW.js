import{aV as g,at as x,ad as a,a as b,l as w,ai as z,ar as B,a_ as T,aj as q}from"./iframe-BsyQNsjg.js";import{u as G}from"./useListFocus-CT4wLc1j.js";const o={group:{k1xSpc:"astryx3nfvp2",kGNEyG:"astryx1qjc9v5",$$css:!0},vertical:{kXwgrk:"astryxdt5ytf",$$css:!0}};function s({children:n,label:i,orientation:e="horizontal",size:l,isDisabled:t=!1,xstyle:u,className:d,style:p,ref:c,"data-testid":m,...f}){const r=g(l,"md"),{listRef:y,handleKeyDown:h}=G({itemSelector:'button, [tabindex="0"]',orientation:e}),v=x.useMemo(()=>({orientation:e,isDisabled:t}),[e,t]);return a.jsx(b,{value:v,children:a.jsx(w,{value:r,children:a.jsx("div",{ref:q(c,y),role:"group","aria-label":i,onKeyDown:h,"aria-orientation":e,"aria-disabled":t||void 0,"data-testid":m,...z(T("button-group",{size:r,orientation:e}),B(o.group,e==="vertical"&&o.vertical,u),d,p),...f,children:n})})})}s.displayName="ButtonGroup";s.__docgenInfo={description:`Groups buttons with connected styling — shared borders, proper border-radius
