import{at as g,a6 as V,ad as e,ai as O,ar as T,a_ as I}from"./iframe-BsyQNsjg.js";import{C as t}from"./Card-BU0ik7sD.js";import{V as m}from"./VStack-CbezWGwW.js";import"./preload-helper-Ct5FWWRu.js";import"./container.stylex-uilBL6DE.js";import"./padding.stylex-ENVgbwco.js";import"./Stack-BJArovWs.js";import"./stack.stylex-BlarxY2N.js";const G=g.createContext(null);G.displayName="CollapsibleGroupContext";function A(a){const{isCollapsible:p,value:n}=a,r=g.use(G),c=r!=null&&n!=null,l=p===!0?{}:p||null,y=l!=null,[h,i]=g.useState(()=>c?!0:l?.isOpen!==void 0?l.isOpen:l?.defaultIsOpen??!0);let d;return c&&n!=null?d=r.isOpen(n):l?.isOpen!==void 0?d=l.isOpen:d=h,{isEnabled:y,isOpen:d,toggle:()=>{c&&n!=null?r.toggle(n):l?.onOpenChange?l.onOpenChange(!d):i(f=>!f)}}}const z={root:{kzqmXN:"astryxh8yej3",$$css:!0}};function s({trigger:a,children:p,defaultIsOpen:n,isOpen:r,onOpenChange:c,value:l,ref:y,xstyle:h,className:i,style:d,...C}){const f=r!==void 0?{isOpen:r,onOpenChange:c}:{defaultIsOpen:n??!0,onOpenChange:c},{isOpen:o,toggle:u}=A({isCollapsible:f,value:l}),k=V("chevronDown");return e.jsxs("div",{ref:y,...O(I("collapsible"),T(z.root,h),i,d),...C,children:[e.jsxs("button",{type:"button",onClick:u,"aria-expanded":o,className:"astryx9f619 astryx78zum5 astryx6s0dn4 astryx1qughib astryxh8yej3 astryx1ypdohk astryx9ynric astryx18juvz8 astryx2mo6ok astryx1tgivj0 astryx1yc453h astryxt970qd",children:[e.jsx("span",{className:"astryx1b2iylo astryxwgcxoh",children:a}),e.jsx("span",{...{0:{className:"astryx3nfvp2 astryx6s0dn4 astryxl56j7k astryx2lah0s astryx11xpdln astryxuedmi6 astryxlr8y92 astryxv9yike astryx7p49u4"},1:{className:"astryx3nfvp2 astryx6s0dn4 astryxl56j7k astryx2lah0s astryx11xpdln astryxuedmi6 astryxlr8y92 astryxv9yike astryx19jd1h0"}}[!!o<<0],children:k})]}),e.jsx("div",{...o?{className:"astryxfsso4q"}:{className:"astryxfsso4q astryx1s85apg"},children:p})]})}s.displayName="Collapsible";s.__docgenInfo={description:`A primitive that makes any content collapsible.
...
Required when using inside a group for coordination.`},"data-testid":{required:!1,tsType:{name:"string"},description:"Test ID for the collapsible element."}},composes:["Omit"]};function N(a){return a==null?[]:Array.isArray(a)?a:[a]}function x({type:a="single",defaultValue:p,value:n,onChange:r,children:c}){const l=n!==void 0,[y,h]=g.useState(()=>N(p)),i=l?N(n):y,d=g.useCallback(o=>i.includes(o),[i]),C=g.useCallback(o=>{let u;a==="single"?u=i.includes(o)?[]:[o]:u=i.includes(o)?i.filter(k=>k!==o):[...i,o],l||h(u),r&&r(a==="single"?u[0]??"":u)},[a,i,l,r]),f=g.useMemo(()=>({isOpen:d,toggle:C}),[d,C]);return e.jsx(G,{value:f,children:c})}x.displayName="CollapsibleGroup";x.__docgenInfo={description:`Groups collapsible components with coordinated open/close behavior.
...
\`\`\``}},composes:["Omit"]};const _={title:"Core/Collapsible",component:x,tags:["autodocs"],decorators:[a=>e.jsx("div",{className:"x1eiddq6 x1gt495",children:e.jsx(a,{})})]},b={name:"Single Mode (default)",render:()=>e.jsx(x,{type:"single",defaultValue:"general",children:e.jsxs(m,{gap:2,children:[e.jsx(t,{children:e.jsx(s,{trigger:"General Settings",value:"general",children:e.jsx("p",{className:"x9ynric x1tgivj0 x1ghz6dp",children:"Configure your general preferences including language, timezone, and display options."})})}),e.jsx(t,{children:e.jsx(s,{trigger:"Privacy Settings",value:"privacy",children:e.jsx("p",{className:"x9ynric x1tgivj0 x1ghz6dp",children:"Manage who can see your profile, activity, and personal information."})})}),e.jsx(t,{children:e.jsx(s,{trigger:"Notification Settings",value:"notifications",children:e.jsx("p",{className:"x9ynric x1tgivj0 x1ghz6dp",children:"Choose which notifications you receive and how they are delivered."})})})]})})},v={name:"Multiple Mode",render:()=>e.jsx(x,{type:"multiple",defaultValue:["faq1","faq3"],children:e.jsxs(m,{gap:2,children:[e.jsx(t,{children:e.jsx(s,{trigger:"What is XDS?",value:"faq1",children:e.jsx("p",{className:"x9ynric x1tgivj0 x1ghz6dp",children:"XDS is a design system for building internal tools and products."})})}),e.jsx(t,{children:e.jsx(s,{trigger:"How do I install it?",value:"faq2",children:e.jsxs("p",{className:"x9ynric x1tgivj0 x1ghz6dp",children:["Run ",e.jsx("code",{children:"npm install @astryxdesign/core"})," to get started."]})})}),e.jsx(t,{children:e.jsx(s,{trigger:"Is it open source?",value:"faq3",children:e.jsx("p",{className:"x9ynric x1tgivj0 x1ghz6dp",children:"Yes! XDS is open source and available on GitHub."})})})]})})},j={name:"Controlled",render:function(){const[p,n]=g.useState("section1");return e.jsxs("div",{children:[e.jsxs("p",{className:"xv1l7n4 xif65rj x9ynric x1ghz6dp",children:["Currently open: ",e.jsx("strong",{children:String(p)||"(none)"})]}),e.jsx(x,{type:"single",value:p,onChange:n,children:e.jsxs(m,{gap:2,children:[e.jsx(t,{children:e.jsx(s,{trigger:"Section 1",value:"section1",children:e.jsx("p",{className:"x9ynric x1tgivj0 x1ghz6dp",children:"Content for section 1."})})}),e.jsx(t,{children:e.jsx(s,{trigger:"Section 2",value:"section2",children:e.jsx("p",{className:"x9ynric x1tgivj0 x1ghz6dp",children:"Content for section 2."})})}),e.jsx(t,{children:e.jsx(s,{trigger:"Section 3",value:"section3",children:e.jsx("p",{className:"x9ynric x1tgivj0 x1ghz6dp",children:"Content for section 3."})})})]})})]})}},S={name:"Standalone Collapsible",render:()=>e.jsxs(m,{gap:2,children:[e.jsx(t,{children:e.jsx(s,{trigger:"Starts open (default)",children:e.jsx("p",{className:"x9ynric x1tgivj0 x1ghz6dp",children:"This collapsible manages its own state. Click the trigger to toggle."})})}),e.jsx(t,{children:e.jsx(s,{trigger:"Starts collapsed",defaultIsOpen:!1,children:e.jsx("p",{className:"x9ynric x1tgivj0 x1ghz6dp",children:"This collapsible starts collapsed. Click to reveal."})})})]})},w={name:"Without Card (standalone)",render:()=>e.jsxs(m,{gap:2,children:[e.jsx(s,{trigger:"Show more details",children:e.jsx("p",{className:"x9ynric x1tgivj0 x1ghz6dp",children:"Collapsible works anywhere; it doesn't require a card wrapper."})}),e.jsx(s,{trigger:"Another section",defaultIsOpen:!1,children:e.jsx("p",{className:"x9ynric x1tgivj0 x1ghz6dp",children:"This section starts collapsed."})})]})},q={name:"FAQ Page",render:()=>e.jsx(x,{type:"single",children:e.jsxs(m,{gap:2,children:[e.jsx(t,{children:e.jsx(s,{trigger:"How do I reset my password?",value:"q1",children:e.jsx("p",{className:"x9ynric x1tgivj0 x1ghz6dp",children:"Go to Settings → Security → Change Password. You'll receive a confirmation email."})})}),e.jsx(t,{children:e.jsx(s,{trigger:"Can I change my username?",value:"q2",children:e.jsx("p",{className:"x9ynric x1tgivj0 x1ghz6dp",children:"Usernames can be changed once every 30 days from your profile settings."})})}),e.jsx(t,{children:e.jsx(s,{trigger:"How do I delete my account?",value:"q3",children:e.jsx("p",{className:"x9ynric x1tgivj0 x1ghz6dp",children:"Account deletion is permanent. Go to Settings → Account → Delete Account. Your data will be removed within 30 days."})})}),e.jsx(t,{children:e.jsx(s,{trigger:"What payment methods are accepted?",value:"q4",children:e.jsx("p",{className:"x9ynric x1tgivj0 x1ghz6dp",children:"We accept Visa, Mastercard, American Express, and PayPal."})})})]})})};b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
...
}`,...q.parameters?.docs?.source}}};const Y=["SingleMode","MultipleMode","Controlled","StandaloneCollapsible","WithoutCard","FAQ"];export{j as Controlled,q as FAQ,v as MultipleMode,b as SingleMode,S as StandaloneCollapsible,w as WithoutCard,Y as __namedExportsOrder,_ as default};
