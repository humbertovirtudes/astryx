import{at as i,ad as e,ai as E,a_ as z,ar as x}from"./iframe-BsyQNsjg.js";import{F as G}from"./Field-CwBWJ3UK.js";import{I as F}from"./Item-ls6cDVeU.js";import"./preload-helper-Ct5FWWRu.js";import"./FieldStatus-CpbQmNrj.js";import"./computeTargetAndRel-BlG0ENK0.js";const N=i.createContext(null);N.displayName="RadioListContext";function o({ref:s,label:r,isLabelHidden:t=!1,description:n,value:d,onChange:l,orientation:g="vertical",isDisabled:v=!1,isRequired:c=!1,isOptional:y=!1,size:b="md",status:u,labelTooltip:h,width:p,xstyle:f,className:_,style:$,"data-testid":P,children:O}){const W=i.useId(),B=i.useId(),w=i.useId(),T=i.useId(),H=i.useMemo(()=>({name:W,value:d,onChange:l,isDisabled:v,isRequired:c,size:b,status:u}),[W,d,l,v,c,b,u]);return e.jsx(G,{ref:s,"data-testid":P,label:r,isLabelHidden:t,description:n,inputID:B,descriptionID:n?w:void 0,isOptional:y,isRequired:c,isDisabled:v,status:u?{type:u.type,message:u.message,messageID:u.message?T:void 0}:void 0,labelTooltip:h,statusVariant:"detached",width:p,xstyle:f,className:_,style:$,children:e.jsx("div",{role:"radiogroup","aria-label":r,"aria-describedby":[n?w:null,u?.message?T:null].filter(Boolean).join(" ")||void 0,"aria-invalid":u?.type==="error"?!0:void 0,"aria-required":c||void 0,...E(z("radio-list",{orientation:g,size:b}),{0:{className:"astryx78zum5 astryx1q0g3np astryx9mgr7n"},1:{className:"astryx78zum5 astryxdt5ytf astryx1txdalj"}}[(g==="vertical")<<0]),children:e.jsx(N,{value:H,children:O})})})}o.displayName="RadioList";o.__docgenInfo={description:`A radio group component for single-value selection.
