const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./iframe-BsyQNsjg.js","./preload-helper-Ct5FWWRu.js","./iframe-KToWbOzE.css"])))=>i.map(i=>d[i]);
import{_ as P}from"./preload-helper-Ct5FWWRu.js";import{aY as V,at as s,ad as t,ai as z,ar as v,a_ as E,aj as W,U as B,J as D,ae as N,aI as C,aZ as U,aK as f,$ as A,X as I,az as $,ay as F,N as O,aL as X}from"./iframe-BsyQNsjg.js";const J=s.lazy(async()=>P(()=>import("./iframe-BsyQNsjg.js").then(a=>a.s),__vite__mapDeps([0,1,2]),import.meta.url).then(a=>({default:a.Tooltip}))),K={1:"h1",2:"h2",3:"h3",4:"h4",5:"h5",6:"h6"};function y({level:a,type:l,accessibilityLevel:i,color:o="primary",display:h="block",maxLines:e=0,hasTruncateTooltip:r=!0,wordBreak:g,textWrap:d,justify:u="start",hasCapsize:m=!1,hasStrikethrough:b=!1,xstyle:T,className:H,style:w,children:k,ref:S,...x}){const R=K[a],q=i&&i!==a?{"aria-level":i}:{},L=g??(e===1?"break-all":"break-word"),_=e>0||m?"block":h,n=V({maxLines:e}),j=typeof r=="string"?r:"above",p=e>0&&r!==!1&&n.isTruncated,c=s.useRef(null),M=e>1?{WebkitLineClamp:e}:void 0;return t.jsxs(t.Fragment,{children:[t.jsx(R,{ref:W(S,n.ref,c),...z(E("heading",{level:a,color:o,...l&&{type:l}}),v(O[o],l?$[l]:F[a],l&&I[l],e===1?f.singleLine:e>1?f.multiLine:A[_],e>0&&U[L],d&&C[d],u!=="start"&&N[u],m&&D.enabled,b&&B.strikethrough,T),H,{...w,...M}),title:p?n.fullText:void 0,...q,...x,children:k}),p&&t.jsx(s.Suspense,{fallback:null,children:t.jsx(J,{anchorRef:c,content:t.jsx("span",{...v(X.content),children:n.fullText}),placement:j})})]})}y.displayName="Heading";y.__docgenInfo={description:`Heading - Semantic heading component
