import{ah as c,aJ as Z,a1 as e,a6 as q,af as B,ay as N,a7 as K,T as w}from"./iframe-CvQtpGNA.js";import{p as G,M as V}from"./Markdown-DWUiAUR0.js";import{B as W}from"./Badge-CMRR2J6z.js";import{H as j}from"./Heading-Huh0L7NH.js";import"./preload-helper-Ct5FWWRu.js";import"./CodeBlock-B0-uYDLD.js";import"./highlightRanges-CMX3mM3G.js";import"./CheckboxListItem-C62wpQu8.js";import"./Field-dHX8CaNz.js";import"./FieldStatus-BCDx5Qb2.js";import"./List-CpENB0-S.js";import"./ListItem-DqESgIar.js";import"./Item-CzeaPCIo.js";import"./computeTargetAndRel-BlG0ENK0.js";import"./CheckboxInput-BdUssCqj.js";import"./Blockquote-C8_m3awo.js";import"./Table-BJTkz749.js";import"./EmptyState-DoyTMi0b.js";import"./useStreamingText-B7G8D1qs.js";import"./Citation-DZlUG2Kp.js";import"./Code-DjKFpoYG.js";const Y=new Set(["ArrowUp","ArrowDown","PageUp","PageDown","Home","End"," ","Spacebar"]);function _(t){let n=t?.parentElement??null;for(;n!=null;){const r=window.getComputedStyle(n).overflowY;if((r==="auto"||r==="scroll"||r==="overlay")&&n.scrollHeight>n.clientHeight)return n;n=n.parentElement}return null}function J(t,n){if(t.length===0)return;const s=n!=null?n.getBoundingClientRect().top:0;if(n!=null?n.scrollTop+n.clientHeight>=n.scrollHeight-2:window.innerHeight+window.scrollY>=document.documentElement.scrollHeight-2)return t[t.length-1].id;let l=t[0].id;for(const v of t){const u=document.getElementById(v.id);if(u==null)continue;const p=u.getBoundingClientRect().top,y=Number.parseFloat(window.getComputedStyle(u).scrollMarginTop)||0;if(p<=s+y+1)l=v.id;else break}return l}function Q({activeId:t,items:n,onActiveIdChange:s,rootRef:r}){const l=t!==void 0,[v,u]=c.useState(n[0]?.id),p=c.useRef(t),y=c.useRef(!1),x=c.useRef(null),k=c.useRef(null),b=c.useRef(n);b.current=n;const g=c.useRef(s);g.current=s;const L=n.map(o=>o.id).join(`
`);p.current=l?t:v,c.useEffect(()=>{if(l||typeof window>"u")return;const o=_(r.current),m=o??window;let i=0;const a=()=>{if(i=0,y.current)return;const h=J(b.current,o);h!=null&&h!==p.current&&(p.current=h,u(h),g.current?.(h))},d=()=>{i===0&&(i=requestAnimationFrame(a))};return k.current=a,a(),m.addEventListener("scroll",d,{passive:!0}),window.addEventListener("resize",d,{passive:!0}),()=>{k.current=null,m.removeEventListener("scroll",d),window.removeEventListener("resize",d),i!==0&&cancelAnimationFrame(i)}},[l,L,r]),c.useEffect(()=>()=>{x.current?.()},[]);const $=o=>{l||u(o),s?.(o)},D=c.useCallback(o=>{if(typeof window>"u"){u(o),p.current=o,g.current?.(o);return}y.current=!0,x.current?.();let m=0;const i=()=>{window.removeEventListener("scrollend",a),window.removeEventListener("wheel",d),window.removeEventListener("touchmove",d),window.removeEventListener("keydown",h),m!==0&&(clearTimeout(m),m=0),x.current=null},a=()=>{i(),y.current=!1,u(o),p.current=o,g.current?.(o)},d=()=>{i(),y.current=!1,k.current?.()},h=X=>{Y.has(X.key)&&d()};window.addEventListener("scrollend",a,{once:!0}),window.addEventListener("wheel",d,{passive:!0}),window.addEventListener("touchmove",d,{passive:!0}),window.addEventListener("keydown",h),m=window.setTimeout(a,1200),x.current=i},[]);return{activeId:l?t:v,setActiveId:$,lockActiveId:D}}const C={root:{k1xSpc:"astryx78zum5",kXwgrk:"astryx1q0g3np",kVAEAm:"astryx1n2onr6",kOIVth:"astryx1lsbc85",kzqmXN:"astryxh8yej3",$$css:!0},activeAnchor:{k48fcG:"astryx7dpabl",$$css:!0},link:{kGNEyG:"astryx6s0dn4",kaIpWk:"astryxh6dtrn",kB7OPa:"astryx9f619",kMwMTN:"astryxv1l7n4",kkrTdU:"astryx1ypdohk",k1xSpc:"astryx78zum5",k63SB2:"astryx1sodnla",kI3sdo:"astryx1a2a7pz",kVAEAm:"astryx1n2onr6",k9WMMc:"astryx1yc453h",kybGjl:"astryx1hl2dhg",kIyJzY:"astryxuedmi6",k1ekBW:"astryxs2xxs2",kAMwcw:"astryxlr8y92",kzqmXN:"astryxh8yej3",kGuDYH:"astryxjm74w1",kLWn49:"astryxw6l6zx",kHE3J0:"astryxe9uy6x",krNwJM:"astryx140uwzg",kSReZ0:"astryxyxi2l3",k3Woio:"astryx17nn4n9",kiEn40:"astryx7s97pk",$$css:!0},activeLink:{kMwMTN:"astryx1tgivj0",k63SB2:"astryx2mo6ok",$$css:!0}},ee={compact:{k8WAf4:"astryxu0wf1k",kLKAdn:null,kGO01o:null,kwRFfy:"astryx1djylfy",kE3dHu:null,kpe85a:null,$$css:!0},default:{k8WAf4:"astryxce4md1",kLKAdn:null,kGO01o:null,kwRFfy:"astryx1djylfy",kE3dHu:null,kpe85a:null,$$css:!0}},I={level1:{kZCmMZ:"astryx126nfab",kE3dHu:null,kpe85a:null,$$css:!0},level2:{kZCmMZ:"astryxchaq28",kE3dHu:null,kpe85a:null,$$css:!0},level3:{kZCmMZ:"astryxc8afjc",kE3dHu:null,kpe85a:null,$$css:!0},level4:{kZCmMZ:"astryx19b7t93",kE3dHu:null,kpe85a:null,$$css:!0}};function te(t){switch(Math.max(1,Math.min(4,t-1||1))){case 1:return I.level1;case 2:return I.level2;case 3:return I.level3;default:return I.level4}}function f({items:t,activeId:n,onActiveIdChange:s,label:r="Table of contents",density:l="default",xstyle:v,className:u,style:p,ref:y,"data-testid":x,...k}){const b=c.useRef(null),g=Z(),L=n!==void 0,{activeId:$,setActiveId:D,lockActiveId:o}=Q({activeId:n,items:t,onActiveIdChange:s,rootRef:b}),m=i=>a=>{const d=document.getElementById(i);d==null||a.defaultPrevented||a.metaKey||a.altKey||a.ctrlKey||a.shiftKey||(a.preventDefault(),window.history.pushState(null,"",`#${i}`),L?D(i):o(i),d.scrollIntoView({behavior:"smooth",block:"start"}))};return e.jsxs("nav",{...k,ref:K(b,y),"aria-label":r,"data-testid":x,...q(N("outline",{density:l}),B(C.root,v),u,p),children:[e.jsx("ul",{className:"astryx78zum5 astryxdt5ytf astryx1lsbc85 astryx1ghz6dp astryx1717udv astryxe8uvvx astryx98rzlu astryxeuugli",role:"list",children:t.map(i=>{const a=i.id===$;return e.jsx("li",{className:"astryx3ct3a4 astryx1ghz6dp astryx1717udv",role:"listitem",children:e.jsx(g,{href:`#${i.id}`,"aria-current":a?"true":void 0,onClick:m(i.id),...q(N("outline-item",{active:a?"active":null,level:i.level}),B(C.link,ee[l],te(i.level),a&&C.activeLink,a&&C.activeAnchor)),children:e.jsx("span",{className:"astryxb3r6kr astryxlyipyv astryxuxw1ft",children:i.label})})},i.id)})}),e.jsx("div",{className:"astryx1n2onr6 astryxfo62xy astryx2lah0s astryx1clqncf","aria-hidden":"true",children:e.jsx("span",{className:"astryx10l6tqk astryx13vifvy astryx1ey2m1c astryx1o0tod astryxfo62xy astryx1m4xfpy astryxjspbzw astryx47corl"})}),e.jsx("span",{...q(N("outline-indicator"),{className:"astryx10l6tqk astryx1o0tod astryxfo62xy astryxowkcby astryxjspbzw astryx47corl astryx1vjfegm astryx1tsffl5 astryx1ltwjim astryx1qjb5ga astryx1xuz8iz astryxkvfbh3 astryxlr8y92"}),"aria-hidden":"true"})]})}f.displayName="Outline";f.__docgenInfo={description:`A table-of-contents navigation component for document headings.
...
}`,...S.parameters?.docs?.source},description:{story:"Deep nesting with multiple indent levels",...S.parameters?.docs?.description}}};const Me=["Basic","Controlled","Compact","WithDocument","ExtractFromMarkdown","ExtractFromHTML","DeepNesting"];export{A as Basic,T as Compact,E as Controlled,S as DeepNesting,H as ExtractFromHTML,O as ExtractFromMarkdown,M as WithDocument,Me as __namedExportsOrder,Ee as default};
